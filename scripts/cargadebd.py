...
actividad1 = Actividad(owner=usuario1, nombre='AnalisisCaso', flujo=flujo1, orden=1)
actividad1.save()
actividad2 = Actividad(owner=usuario1, nombre='AnalisisEmpresa', flujo=flujo1, orden=2)
actividad2.save()
actividad3 = Actividad(owner=usuario1, nombre='AnalisisRequerimientos', flujo=flujo1, orden=3)
actividad3.save()
actividad4 = Actividad(owner=usuario1, nombre='AnalisisSistema', flujo=flujo1, orden=4)
actividad4.save()
...
us1 = UserStory(flujo_actual=flujo1, sprint=sprint1, actividad_actual=actividad1,
                owner=usuario1, prioridad= 15, fecha_ini='2015-06-28 23:03:05.654997-04',
                fecha_fin='2015-07-04 23:03:05.654997-04', valorNegocio=800, valorTecnico=10)
us1.save()
